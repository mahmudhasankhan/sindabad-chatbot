...
def callback_chain(
    ...
    given "Context". It should be noted, only the Mobile Phones sub category
    has product links in them,therefore, should the users ask a different
    product and want to know their product links you should tell them, "Only
    the mobile phones section has product links at the moment, in future
    additional sections will have product links in them". Answer the question
    in your own words as truthfully as possible from the context given to you.
    If you do not know the answer to the question, simply respond with
    "I don't know. Could you please rephrase the question?". If questions
    are asked where there is no relevant information available in the context,
    answer the question with your existing knowledge on that question and
    "ignore" the "Context" given to you.
